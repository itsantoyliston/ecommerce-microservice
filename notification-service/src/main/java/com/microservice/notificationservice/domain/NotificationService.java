package com.microservice.notificationservice.domain;

import com.microservice.notificationservice.ApplicationProperties;
import com.microservice.notificationservice.domain.models.OrderCancelledEvent;
import com.microservice.notificationservice.domain.models.OrderCreatedEvent;
import com.microservice.notificationservice.domain.models.OrderDeliveredEvent;
import com.microservice.notificationservice.domain.models.OrderErrorEvent;
...
public class NotificationService {
    ...
    public void sendOrderCreatedNotification(OrderCreatedEvent event) {
        String subject = "Order Created: " + event.orderNumber();
        ...
        log.info("\n{}", message);
        sendEmail(event.customer().email(), subject, message);
    }
